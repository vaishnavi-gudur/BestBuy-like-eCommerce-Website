...
pw.println("<tr><td>User:</td><td>Product Name:</td><td>Price:</td><td>Address:</td><td>Delivery Date:</td></tr>");
String ab="";
		while(rs.next())
		{
			...
			String prodaddress = rs.getString("address");
			String proddate = rs.getString("deliveryDate");
			
			pw.println("<tr>");
			pw.println("<td>"+ouser+"</td>");
			pw.println("<td>"+prodname+"</td>");
			pw.println("<td>"+prodprice+"</td>");
			pw.println("<td>"+prodaddress+"</td>");
			pw.println("<td>"+proddate+"</td>");
			pw.println("</tr>");
			//pw.println("</table>");			
		//pw.println(ab);
		}
