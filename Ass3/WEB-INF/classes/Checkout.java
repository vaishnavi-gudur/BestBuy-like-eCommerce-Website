...
pw.println("<article>");
pw.println("<p style='position:fixed;left:75%;top:40%'><a href='#' style='text-decoration:none'>Account&nbsp&nbsp</a><a href='orderinfo' style='text-decoration:none'>Orders&nbsp&nbsp</a><a href='#' style='text-decoration:none'>Cart</a></p>");
		CartManage shcart;
		...
		{
			pw.println("");
			pw.println("<form action='order' method='get'><tr><td>UserName:</td><td>"+user+"</td></tr><tr><td>Product Name:</td><td>"+productName+"</td></tr><tr><td>Price:</td><td>"+items.get(k)+"</td></tr><tr><td>Credit Card No:</td><td><input type='text' name='credit'></td></tr><tr><td>Address:</td><td><input type='text' name='address'></td></tr><tr><td><input type='submit' name='order' value='order'></td></tr><input type='hidden' name='username' value="+user+"><input type='hidden' name='productName' value='productName'><input type='hidden' name='price' value="+items.get(k)+"><input type='hidden' name='credit' value='credit'><input type='hidden' name='address' value='address'><input type='hidden' name='deliveryDate' value='deliveryDate'><input type='hidden' name='orderid' value="+t.nextInt(100)+"></form>");
