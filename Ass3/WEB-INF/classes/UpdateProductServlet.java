...
pw.println("<form action='productupdate' method='get'><table><tr><td>Enter the product Name</td><td><input type='text' name='productName'></tr><tr><td><input type='submit' name='submit' value='Submit'></td></tr><input type='hidden' name='productName' value='productName'></table></form>");
