...
public class AjaxUtility {
    ...
    public HashMap getProducts() {
		...
		String selectCustomerQuery="select id,productName,price from products";
		ResultSet rs = stmt.executeQuery(selectCustomerQuery);
		while(rs.next())
		{
		ProductInfo productinfo = new ProductInfo(rs.getString("id"), rs.getString("productName"));
		products.put(rs.getString("id"), productinfo);
		}
		}
		catch(Exception e)
		{}
