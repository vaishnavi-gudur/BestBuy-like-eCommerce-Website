...
try {
	...
	//pw.println("HELLO");
	saxParser.parse(context.getRealPath("samsung.xml"), handler);
	//pw.println(temp);
		
	Map<String,String> hm = new HashMap<String,String>();
	String arr[] = temp.split("-");
	pw.println("<p style='color:red'>Welcome &nbsp&nbsp"+user+"</p>");
	pw.println("<br><br>");
	for(int i=0;i<arr.length; i++)
	{
		...
		//hm.put(arr1[0], "<html><head></head><body><table><th>Name: "+arr1[1]+"<br>Brand: "+arr1[2]+"<br>Condition: "+arr1[3]+"<br>Price: "+arr1[4]+"<br><br>");
