...
pw.println("<article>");
/*HashMap<String,ArrayList<OrderPayment>> orderPayments= new HashMap<String,ArrayList<OrderPayment>>();
ArrayList<OrderPayment> orderList=new ArrayList<OrderPayment>();
OrderPayment orders = new OrderPayment(user,prodName,prodprice,creditNo,useraddress);

MySQLDataStoreUtilities my = new MySQLDataStoreUtilities();

my.selectOrder();
pw.println("<table border='1px'><tr><td>Product Name:</td><td>"+orders.getUsername()+"</td></tr><tr><td>Price:</td><td>"+orders.getPrice()+"</td></tr><tr><td>Address:</td><td>"+orders.getAddress()+"</td></tr></table>");*/
