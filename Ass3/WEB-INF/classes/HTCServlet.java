...
public class HTCServlet extends HttpServlet{
String temp = "";
...
pw.println("<article>");
pw.println("<p style='position:relative;left:75%;top:40%'><a href='#' style='text-decoration:none'>Account&nbsp&nbsp</a><a href='orderinfo' style='text-decoration:none'>Orders&nbsp&nbsp</a><a href='#' style='text-decoration:none'>Cart</a></p>");
...
try {
	...
	//pw.println("HELLO");
	saxParser.parse(context.getRealPath("htc.xml"), handler);
	//pw.println(temp);
